...
syntax keyword cppSTLconstant
        \ adjustfield app ate basefield binary floatfield in out trunc boolalpha dec fixed hex internal oct scientific showbase showpoint showpos skipws unitbuf uppercase
