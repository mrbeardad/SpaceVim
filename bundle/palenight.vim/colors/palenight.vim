...
call s:h("NonText",       { "fg": s:comment_grey })
call s:h("CursorLine",    { "bg": s:vertsplit })
call s:h("CursorLineNr",  { "fg": s:light_red,    "gui": "bold" })
