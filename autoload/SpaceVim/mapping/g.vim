...
function! SpaceVim#mapping#g#init() abort
    ...
    let g:_spacevim_mappings_g['p'] = ['call feedkeys("gp", "n")', 'Select last paste']
    ...
    let g:_spacevim_mappings_g['#'] = ['call feedkeys("g#", "n")', 'search under cursor backward']
    nnoremap g# g#
    let g:_spacevim_mappings_g['*'] = ['call feedkeys("g*", "n")', 'search under cursor forward']
    nnoremap g* g*
