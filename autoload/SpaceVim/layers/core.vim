...
function! SpaceVim#layers#core#config() abort
  ...
  elseif g:spacevim_filemanager ==# 'defx'
    ...
    call SpaceVim#mapping#space#def('nnoremap', ['f', 'o'], "Defx  -show-ignored-files -no-toggle -search=`expand('%:p')` `stridx(expand('%:p'), getcwd()) < 0? expand('%:p:h'): getcwd()`", 'open-file-tree', 1)
